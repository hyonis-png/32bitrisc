...
REM
REM Generated by Vivado on Sat Jun 20 23:28:11 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj cpu_top_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj cpu_top_tb_vlog.prj -log xvlog.log
