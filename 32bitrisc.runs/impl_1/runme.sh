...
HD_PWD='C:/Users/heyso/OneDrive/Desktop/32bitrisc/32bitrisc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_fpga.tcl -notrace
