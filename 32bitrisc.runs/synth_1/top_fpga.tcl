...
synth_design -top top_fpga -part xc7s25csga324-1
...
generate_parallel_reports -reports { "report_utilization -file top_fpga_utilization_synth.rpt -pb top_fpga_utilization_synth.pb"  } 
